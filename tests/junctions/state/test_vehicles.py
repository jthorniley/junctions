...
def test_insert_vehicle():
    ...
    vehicles = (
        VehiclesState()
        .add_vehicle(Vehicle(LaneRef("road1", "a"), 0.0))
        .add_vehicle(Vehicle(LaneRef("road2", "b"), 0.0))
    )
...
def test_update_vehicles():
    ...
    original_vehicle = Vehicle(LaneRef("road1", "a"), 0.0)
    new_vehicle_1 = Vehicle(LaneRef("road2", "a"), 1.0)
    new_vehicle_2 = Vehicle(LaneRef("road3", "b"), 2.0)
